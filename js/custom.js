(function(){
  ...
  // services section hover effect you can customize it . See Documentation for further information 

  var $items = $('.itemFullyPurposeDesign,.itemOneClickColorChange,.itemLotsOfVeriationsInclude,.itemDragDropBuilder,.itemInBrowserEditing,.itemOnlineSupport').click(function() {
